...
var LikeStatus = /** @class */ (function () {
    function LikeStatus(likeCount) {
        this.likeCount = likeCount;
    }
    LikeStatus.prototype.like = function () {
        this.likeCount++;
        this.showLikeCount();
    };
    LikeStatus.prototype.unLike = function () {
        this.likeCount--;
        this.showLikeCount();
    };
    LikeStatus.prototype.showLikeCount = function () {
        console.log("Like Counts:" + this.likeCount);
    };
    return LikeStatus;
}());
